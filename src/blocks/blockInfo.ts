...
import { parentBrokeInPastBlock } from "../utils/util";
...
export class BlockInfo {
    ...
    isBlockReplaceable(block: Block): boolean {
        return block.shapes.length === 0 || (!this.canStandOnBlock(block) && this.autoReplaceIDs.has(block.type));
    }
