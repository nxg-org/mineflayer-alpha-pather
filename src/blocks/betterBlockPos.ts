 ...
 */
export class BetterBlockPos extends Vec3 {
    ...
    public static fromXYZ(world: any, vec: {x: number, y: number, z: number}): BetterBlockPos {
        return new BetterBlockPos(world, vec.x, vec.y, vec.z);
    }
    ...
    offsetB(x: number, y: number, z: number): BetterBlockPos {
        return new BetterBlockPos(this.world, this.x + x, this.y + y, this.z + z);
    }

    subtractB(x: number, y: number, z: number): BetterBlockPos {
        return new BetterBlockPos(this.world, this.x - x, this.y - y, this.z - z);
    }
    scaleB(scale: number): BetterBlockPos {
